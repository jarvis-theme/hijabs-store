        ...
        <article>
            ...
            <div class="address">
                <address>
                    ...
                    @endif
                    @if(!empty($kontak->hp))
                        <abbr title="Mobile Phone">M:</abbr> {{$kontak->hp}}<br>
                    @endif
                    @if(!empty($kontak->bb))
                        <abbr title="BBM">B:</abbr> {{$kontak->bb}}<br>
                    @endif
                </address>
                <address>
            ...
            @else
                <iframe style="float:right;width:100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q={{ $kontak->alamat }}&amp;aq=0&amp;oq={{ $kontak->alamat }}&amp;sspn={{ $kontak->lat.','.$kontak->lng }}&amp;ie=UTF8&amp;hq=&amp;hnear={{ $kontak->alamat }}&amp;t=m&amp;z=14&amp;iwloc=A&amp;output=embed"></iframe><br />
            @endif
        </article>
    </section>
</section>